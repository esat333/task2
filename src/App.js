  ...
  return (
    <div className="App">
      <header className="header bg-primary text-white py-5 text-center">
        <h1 className="name">Satwika Elaprolu</h1>
      ...
      <section className="contact py-5 bg-primary text-white">
        <div className="container">
          ...
          <p>Email: satwika.elaprolu@gmail.com</p>
          <p>Contact: +91 9948808333</p>
          <p>GitHub: <a href="https://github.com/esat333" target="_blank" rel="noopener noreferrer">GitHub Profile</a></p>
        </div>
      </section>
    </div>
  );
